            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Create a new tag with automatic criteria matching for your transactions.</p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Create a new tag with a name, color, and optional description.</CardDescription>
                            </CardHeader>
